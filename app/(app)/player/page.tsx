...
export default function PlayerPage() {
  ...
  // Extract dominant color from thumbnail for dynamic theming
  useEffect(() => {
    if (!currentSong?.thumbnail) {
      setDominantColor("oklch(0.18 0 0)");
      return;
    }
    ...
    img.onload = () => {
      try {
        ...
        // Create a muted, dark version of the dominant color
    ...
    img.onerror = () => setDominantColor("oklch(0.18 0 0)");
